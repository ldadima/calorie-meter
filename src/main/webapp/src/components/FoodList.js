...
export default class FoodList extends React.Component {
    ...
    addFood = () => {
        ...
        this.handleClose();
        axios.post("http://" + (process.env.NODE_ENV === "production" ? "10.170.0.2" : "localhost")   + ":8080/calorie-meter/user/addFood?login="+ info.login + "&foodId="+info.foodId+"&weight="+info.weight)
            .then(response => {
                this.setState({
                    "show": true,
