...
export default class FoodList extends React.Component {
    ...
    findAllFood(currentPage) {
        currentPage -= 1;
        axios.get("http://127.0.0.1:8080/calorie-meter/food/allFood?page="+currentPage+"&size="+this.state.foodsPerPage)
    ...
    searchData = (currentPage) => {
        ...
        axios.get("http://127.0.0.1:8080/calorie-meter/food/foodContainsString?subName="+this.state.search+"&page="+currentPage+"&size="+this.state.foodsPerPage)
            .then(response => response.data)
            .then((data) => {
                this.setState({
                    foods: data.content,
    ...
    addFood = () => {
        ...
        this.handleClose();
        axios.post("http://127.0.0.1:8080/calorie-meter/user/addFood?login="+ info.login + "&foodId="+info.foodId+"&weight="+info.weight)
            .then(response => {
                this.setState({
                    "show": true,
