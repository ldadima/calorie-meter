...
public enum CalculateNormTest {
    NULL(null, null),
    MALE(new User( "kek", "kek", Date.valueOf(LocalDate.now()), 32, 80, 175, Gender.MALE), 1739),
    FEMALE(new User( "kek", "kek", Date.valueOf(LocalDate.now()), 32, 80, 175, Gender.FEMALE), 1573);
